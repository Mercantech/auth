...
|-------|------------------------------------------------------------------------|
| Presets | `mercantec` (standard), `mercanlink`, `gf2learn` (GF2 Learn / `gf2-learn`), `uptimedaddy` (Uptime Daddy / `uptime-daddy`), … — se `login_themes` i [manifest](https://auth.mercantec.tech/.well-known/mercantec-auth.json) |
