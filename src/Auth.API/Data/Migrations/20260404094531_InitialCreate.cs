    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientAppRedirectUris", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientAppRedirectUris_ClientApps_ClientAppId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientStringId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocalLogins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocalLogins_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientAppRedirectUris_ClientAppId",
                table: "ClientAppRedirectUris",
                column: "ClientAppId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocalLogins_Email",
                table: "LocalLogins",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LocalLogins_UserId",
                table: "LocalLogins",
                column: "UserId",
                unique: true);
